...
import static zach.cheatz.ModBlocks.END_PLATINUM_ORE;
...
*/
	...
	public void onInitialize() {
		...
		//Platinum Block
		Registry.register(Registry.BLOCK, new Identifier("cheatz", "platinum_block"), ModBlocks.PLATINUM_BLOCK);
		Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_block"), new BlockItem(ModBlocks.PLATINUM_BLOCK, new FabricItemSettings().rarity(Rarity.EPIC).group(ItemGroup.BUILDING_BLOCKS)));

		//Raw Platinum Block
		Registry.register(Registry.BLOCK, new Identifier("cheatz", "raw_platinum_block"), ModBlocks.RAW_PLATINUM_BLOCK);
		Registry.register(Registry.ITEM, new Identifier("cheatz", "raw_platinum_block"), new BlockItem(ModBlocks.RAW_PLATINUM_BLOCK, new FabricItemSettings().rarity(Rarity.EPIC).group(ItemGroup.BUILDING_BLOCKS)));

		//Platinum Ore
		Registry.register(Registry.BLOCK, new Identifier("cheatz", "platinum_ore"), ModBlocks.PLATINUM_ORE);
		Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_ore"), new BlockItem(ModBlocks.PLATINUM_ORE, new FabricItemSettings().rarity(Rarity.EPIC).group(ItemGroup.BUILDING_BLOCKS)));

		//End Platinum Ore
		Registry.register(Registry.BLOCK, new Identifier("cheatz", "end_platinum_ore"), END_PLATINUM_ORE);
		Registry.register(Registry.ITEM, new Identifier("cheatz", "end_platinum_ore"), new BlockItem(END_PLATINUM_ORE, new FabricItemSettings().rarity(Rarity.EPIC).group(ItemGroup.BUILDING_BLOCKS)));
		//Deepslate Platinum Ore: will probably never add


		//Ore Generation
		/*
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, new Identifier("cheatz","overworld_platinum_ore"), OVERWORLD_PLATINUM_ORE_CONFIGURED_FEATURE);
		Registry.register(BuiltinRegistries.PLACED_FEATURE, new Identifier("cheatz", "overworld_platinum_ore"), OVERWORLD_PLATINUM_ORE_PLACED_FEATURE);
		BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES, RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier("cheatz", "overworld_platinum_ore")));
		*/
		Registry.register(BuiltinRegistries.CONFIGURED_FEATURE,
				new Identifier("cheatz", "overworld_platinum_ore"), OVERWORLD_PLATINUM_ORE_CONFIGURED_FEATURE);
		Registry.register(BuiltinRegistries.PLACED_FEATURE, new Identifier("cheatz", "overworld_platinum_ore"),
				OVERWORLD_PLATINUM_ORE_PLACED_FEATURE);
		BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES,
				RegistryKey.of(Registry.PLACED_FEATURE_KEY,
						new Identifier("cheatz", "overworld_platinum_ore")));
	}
...
//Raw Platinum
	public static final Item RAW_PLATINUM =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "raw_platinum"),
					new Item(new FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.EPIC)));

	//Platinum Ingot
	public static final Item PLATINUM_INGOT =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_ingot"),
					new Item(new FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.EPIC)));

	//Platinum Nugget
	public static final Item PLATINUM_NUGGET =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_nugget"),
					new Item(new FabricItemSettings().group(ItemGroup.MISC).rarity(Rarity.EPIC)));
	...
	public static final Item TEST_FOOD =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "test_food"),
	...
	public static final ToolItem PLATINUM_PICKAXE =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_pickaxe"),
	...
	public static final ToolItem PLATINUM_AXE =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_axe"),
	...
	public static final ToolItem PLATINUM_SHOVEL =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_shovel"),
	...
	public static final ToolItem PLATINUM_HOE =
		Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_hoe"),
	...
	public static final ToolItem PLATINUM_SWORD =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_sword"),
	...
	//Armor
	private static ArmorMaterial PlatinumArmorMaterial = new zach.cheatz.PlatinumArmorMaterial();

//Helmet
	public static  final ArmorItem PLATINUM_HELMET =
		Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_helmet"),
	...
	public static  final ArmorItem PLATINUM_CHESTPLATE =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_chestplate"),
	...
	public static  final ArmorItem PLATINUM_LEGGINGS =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_leggings"),
	...
	public static  final ArmorItem PLATINUM_BOOTS =
			Registry.register(Registry.ITEM, new Identifier("cheatz", "platinum_boots"),
